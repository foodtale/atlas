...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "foodtale"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "atlas.authentication.SessionTokenAuthentication",
    ],
    "EXCEPTION_HANDLER": ("atlas.exception.custom_exception_handler"),
}

ATLAS_VERSION = tomllib.load(open(BASE_DIR / "pyproject.toml", "rb"))["project"][
    "version"
]
